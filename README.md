...
- [ ] Explain the difference between `Relational Databases` and `SQL`.
  ...
  A relational Database is the collection of data, stored in tables with rows/columns. Sql is the query language that allows you to access/manipulate that data.

- [ ] Why do tables need a `primary key`?

  Primary Keys allow you to uniquely identify each entry in the database. 

- [ ] What is the name given to a table column that references the primary key on another table.
  Foreign Key

- [ ] What do we need in order to have a _many to many_ relationship between two tables.
 You need an  intermediary table that has a foreign key for each table you want to relate by referencing its primary key
